        ...
        <div className="md:col-span-2">
          ...
          <div className="text-[22px] leading-relaxed space-y-6">
            ...
            <p>
              ...
              systems that generalize across tasks, environments, and robot
              embodiments.
            </p>
            ...
            <p>
              Previously, I worked with Prof. Xin Yi at Tsinghua University
              and contributed to foundation models for large-scale
              time-series learning at Siemens Research.
            </p>
      ...
      <section className="mt-32">
        ...
        <div className="grid md:grid-cols-3 gap-10 mb-24">
          ...
          <div className="md:col-span-2">
            ...
            <h3 className="text-3xl font-semibold mb-3">
              Weco: Equivariant World Changes for Object-Centric Policy Learning
            </h3>
            ...
            <div className="text-[21px] leading-relaxed space-y-4">
              ...
              <p>
                World-model-based planning with position-equivariant
                and geometry-invariant inverse dynamics models.
              </p>

              <p>
                Leveraging large-scale 2D visual priors to enable
                generalization across manipulation skills, objects,
                backgrounds, spatial configurations, and robot embodiments.
              </p>
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <h3 className="text-3xl font-semibold mb-3">
              AbsVLA: Robust Vision-Language-Action Policies via
              Object-Centric Abstraction
            </h3>

            <p className="text-xl mb-4">
              Your Name, Zackory Erickson
            </p>
            ...
            <div className="text-[21px] leading-relaxed space-y-4">
              ...
              <p>
                Object-centric abstract state representations for robust
                vision-language-action policies under visual and language
                distribution shifts.
              </p>

              <p>
                Achieved stronger robustness on LIBERO benchmarks and
                demonstrated zero-shot sim-to-real transfer from
                Franka Panda simulation to Hello Robot Stretch.
              </p>
      ...
      <section className="mt-32 mb-32">
        ...
        <div className="space-y-10 text-[22px] leading-relaxed">
          ...
          <div>
            ...
            <p className="mt-4">
              Contributed to the development of General Time Transformer (GTT),
              an encoder-only foundation model for zero-shot multivariate
              time-series forecasting trained on 2.9TB industrial data.
            </p>
